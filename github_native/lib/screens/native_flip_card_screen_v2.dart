...
class NativeFlipCardScreenV2 extends StatefulWidget {
  final String fileName;

  const NativeFlipCardScreenV2({super.key, required this.fileName});

  @override
  State<NativeFlipCardScreenV2> createState() => _NativeFlipCardScreenV2State();
}

class _NativeFlipCardScreenV2State extends State<NativeFlipCardScreenV2> with SingleTickerProviderStateMixin {
